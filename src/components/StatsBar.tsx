    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
      ...
      >
        ...
        <div className="mt-2 flex items-baseline gap-2">
          ...
          <span className="text-xs text-slate-500">PDFs</span>
        </div>
        <p className="mt-1 text-xs text-slate-500 font-medium">17 Exam Cycles (2010–2026)</p>
      </button>
      ...
      >
        ...
        <p className="mt-1 text-xs text-slate-500 font-medium">2017–2025 New Syllabus</p>
      </button>
      ...
      >
        ...
        <p className="mt-1 text-xs text-slate-500 font-medium">Bengali & English Mediums</p>
      </button>
      ...
      >
        ...
        <p className="mt-1 text-xs text-slate-500 font-medium">2010 to 2016 Exam Cycles</p>
      </button>
